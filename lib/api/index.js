...
var Sophia = function (_EventEmitter) {
    ...
    _createClass(Sophia, [{
        ...
        value: function startBroadcasting(operation, privateKey, callback) {
            ...
            try {
                return this.call('alexandria_api.create_simple_transaction', { operation: operation }, function (err, response) {
                    if (err) callback(err, '');else {
                        ...
                        _this2.call('alexandria_api.broadcast_transaction', { signedTransaction: signedTransaction }, function (err, response) {
                            if (err) {
                                // logger.log(err);
                                callback(err, '');
                            } else {
                                    ...
                                    if (err) callback(err, '');else {
                                        ...
                                        _this3.call('alexandria_api.create_simple_transaction', [transaction], function (err, response) {
                                            if (err) callback(err, '');else {
                                                ...
                                                _this3.call('alexandria_api.broadcast_transaction', [signedTransaction], function (err, response) {
                                                    if (err) {
                                                        // logger.log(err);
                                                        callback(err, '');
                                                    } else {
...
sophia.createAccount = function (creator, seed, privateKey, jsonMeta, owner, active, memoKey, callback) {
    ...
    return sophia.call('alexandria_api.create_account', { creator: creator, seed: seed, jsonMeta: jsonMeta, owner: owner, active: active, memoKey: memoKey }, function (err, response) {
        if (err) {
            //logger.log(err);
            callback(err, '');
        } else {
...
sophia.updateAccount = function (accountName, jsonMeta, owner, active, memoKey, privateKey, callback) {
    return sophia.call('alexandria_api.update_account', { accountName: accountName, jsonMeta: jsonMeta, owner: owner, active: active, memoKey: memoKey }, function (err, response) {
...
sophia.deleteAccount = function (accountName, privateKey, callback) {
    return sophia.call('alexandria_api.delete_account', { accountName: accountName }, function (err, response) {
        if (err) callback(err, '');else {
            sophia.startBroadcasting(response, privateKey, callback);
        }
    });
...
sophia.transferToVesting = function (from, to, amount, privateKey, callback) {
    return sophia.call('transfer_to_vesting', [from, to, amount], function (err, response) {
        if (err) callback(err, '');else {
            sophia.startBroadcasting(response, privateKey, callback);
        }
    });
...
sophia.setVotingProxy = function (accountToModify, proxy, private_key, callback) {
    return sophia.call('set_voting_proxy', [accountToModify, proxy], function (err, response) {
        if (err) callback(err, '');else {
...
sophia.voteForWitness = function (accountToVoteWith, accountToVoteFor) {
    ...
    return sophia.call('vote_for_witness', [accountToVoteWith, accountToVoteFor, approve], function (err, response) {
        if (err) callback(err, '');else {
            sophia.startBroadcasting(response, private_key, callback);
        }
    });
...
sophia.withdrawVesting = function (from, vestingShares, privateKey, callback) {
    return sophia.call('withdraw_vesting', [from, vestingShares], function (err, response) {
        if (err) callback(err, '');else {
            sophia.startBroadcasting(response, privateKey, callback);
        }
    });
...
sophia.updateWitness = function (accountName, url, blockSigningKey, accountCreationFee, maximumBlockSizeLimit, prizeFeeds, private_key, callback) {
    ...
    return sophia.call('update_witness', [accountName, url, blockSigningKey, props], function (err, response) {
        if (err) callback(err, '');else {
            sophia.startBroadcasting(response, private_key, callback);
        }
    });
...
sophia.getAccountHistoryByType = function (accountName, type, from, limit, callback) {
    return sophia.call('get_account_history', [accountName, from, limit], function (err, response) {
        if (err) callback(err, '');else {
...
sophia.getWitness = function (nameOfTheWitness, callback) {
    return sophia.call('alexandria_api.get_witness', { nameOfTheWitness: nameOfTheWitness }, function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.listWitnesses = function (name, limit, callback) {
    return sophia.call('alexandria_api.list_witnesses', { name: name, limit: limit }, function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.getBlock = function (blockNum, callback) {
    return sophia.call('alexandria_api.get_block', { blockNum: blockNum }, function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.getOpsInBlock = function (blockNum, onlyVirtual, callback) {
    return sophia.call('alexandria_api.get_ops_in_block', { blockNum: blockNum, onlyVirtual: onlyVirtual }, function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.getAccount = function (name, callback) {
    return sophia.call('alexandria_api.get_account', { name: name }, function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.getTransaction = function (trxId, callback) {
    return sophia.call('alexandria_api.get_transaction', { trxId: trxId }, function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.accountExist = function (accountName, callback) {
    return sophia.call('alexandria_api.account_exist', { accountName: accountName }, function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.getActiveAuthority = function (accountName, callback) {
    return sophia.call('alexandria_api.get_active_authority', { accountName: accountName }, function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.getOwnerAuthority = function (accountName, callback) {
    return sophia.call('alexandria_api.get_owner_authority', { accountName: accountName }, function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.getMemoKey = function (accountName, callback) {
    return sophia.call('alexandria_api.get_memo_key', { accountName: accountName }, function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.getAccountBalance = function (accountName, callback) {
    return sophia.call('alexandria_api.get_account_balance', { accountName: accountName }, function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.getVestingBalance = function (accountName, callback) {
    return sophia.call('alexandria_api.get_vesting_balance', { accountName: accountName }, function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.sponsorAccountFees = function (sponsoring_account, sponsored_account, is_sponsoring, privateKey, callback) {
    return sophia.call('alexandria_api.sponsor_account_fees', { sponsoring_account: sponsoring_account, sponsored_account: sponsored_account, is_sponsoring: is_sponsoring }, function (err, response) {
        if (err) callback(err, '');else {
            //callback('', response);
            sophia.startBroadcasting(response, privateKey, callback);
        }
...
sophia.getReceivedDocuments = function (appId, accountName, searchType, start, count, callback) {
    return sophia.call('alexandria_api.get_received_documents', { appId: appId, accountName: accountName, searchType: searchType, start: start, count: count }, function (err, response) {
        if (err) callback(err, '');else {
            if (response.length > 0) {
                response.forEach(function (r) {
...
sophia.makeCustomJSONOperation = function (appId, from, to, data, privateKey, callback) {
    return sophia.call('alexandria_api.make_custom_json_operation', { appId: appId, from: from, to: to, data: data }, function (err, response) {
        if (err) callback(err, '');else {
            sophia.startBroadcasting(response, privateKey, callback);
        }
    });
...
sophia.makeCustomBinaryOperation = function (appId, from, to, data, privateKey, callback) {
    return sophia.call('alexandria_api.make_custom_binary_operation', { appId: appId, from: from, to: to, data: data }, function (err, response) {
        if (err) callback(err, '');else {
            sophia.startBroadcasting(response, privateKey, callback);
        }
    });
