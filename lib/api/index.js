...
functions.setOptions = function (options) {
 ...
 * @returns {object}
 */
functions.createAccount = function (creator, seed, private_key, json_meta, owner, active, memo_key, callback) {
 ...
 * @returns {object}
 */
functions.updateAccount = function (account_name, json_meta, owner, active, memo_key, private_key, callback) {
 ...
 * @returns {object}
 */
functions.deleteAccount = function (account_name, private_key, callback) {
 ...
 * @returns {object}
 */
functions.transfer = function (from, to, amount, memo, private_key, callback) {
 ...
 * @returns {object}
 */
functions.transferToVesting = function (from, to, amount, private_key, callback) {
 ...
 * @returns {object}
 */
functions.setVotingProxy = function (account_to_modify, proxy, private_key, callback) {
 ...
 * @returns {object}
 */
functions.voteForWitness = function (accountToVoteWith, witness_to_vote_for) {
 ...
 * @returns {object}
 */
functions.withdrawVesting = function (from, vesting_shares, private_key, callback) {
 ...
 * @returns {object}
 */
functions.updateWitness = function (account_name, url, block_signing_key, accountCreationFee, maximumBlockSizeLimit, prizeFeeds, private_key, callback) {
 ...
 * @return {Object}
 */
functions.getAccountHistoryByType = function (accountName, type, from, limit, callback) {
 ...
 * @return {Object}
 */
functions.getAccountTransferHistory = function (accountName, from, limit, callback) {
    return sophia.call('get_account_history', [accountName, from, limit], function (err, response) {
        if (err) callback(err, '');else {
            response.forEach(function (r) {
                var operationName = r[r.length - 1].op[r.length - 2];
...
exports = module.exports = {
    sophia: sophia, functions: functions
};
