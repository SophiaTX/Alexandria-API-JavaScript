...
var Sophia = function (_EventEmitter) {
    ...
    _createClass(Sophia, [{
        ...
        value: function startBroadcasting(operation, privateKey, callback) {
            ...
            try {
                return this.call('alexandria_api.create_simple_transaction', operation, function (err, response) {
                    if (err) callback(err, '');else {
                        ...
                        _this2.call('alexandria_api.broadcast_transaction', signedTransaction, function (err, response) {
                            if (err) {
                                // logger.log(err);
                                callback(err, '');
                            } else {
