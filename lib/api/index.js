    ...
    return sophia.call('alexandria_api.get_account', { account_name: adminName }, function (err, res) {
        if (err) return callback(err);else {
            ...
            membersArray.forEach(function (r) {
                ...
                sophia.call('alexandria_api.get_account', { account_name: r }, function (err, response) {
                    accounts = response;
                });
                ...
                var data = sophia.encodeAndPack(privateKey, pk, group_operation.toObject(group_object));
                var group_meta = {
                    sender: pk,
