        ...
        value: function call(method, params, callback) {
            try {
                if (this._transportType !== 'http') {
                    ...
                    _logging2.default.emitError(new Error('RPC methods can only be called when using http transport'));
                ...
                (0, _http.jsonRpc)(this.options.uri, { method: method, params: params, id: id }).then(function (res) {
                    ...
                    _logging2.default.emitError(err);
                    callback(err, null);
                });
            } catch (e) {
                callback(e, null);
                    ...
                    if (err) callback(err, '');else {
                        _this2.call('add_fee', [operation, response], function (err, response) {
                            if (err) callback(err, '');else {
                                ...
                                _this2.call('about', [operation, response], function (err, response) {
                                    if (err) callback(err, '');else {
                                        chainId = response.chain_id;
                                        _this2.call('create_simple_transaction', [transaction], function (err, response) {
                                            if (err) callback(err, '');else {
