                            ...
                            if (err) {
                                ...
                                _this2.call('create_simple_transaction', [response], function (err, response) {
                                    if (err) callback(err, null);else {
                                        ...
                                        _this2.call('get_transaction_digest', [transaction], function (err, response) {
                                            if (err) callback(err, null);else {
 ...
 * @returns {object}
 */
sophia.createAccount = function (creator, seed, private_key, json_meta, owner, active, memo_key, callback) {

    return sophia.call('create_account', [creator, seed, json_meta, owner, active, memo_key], function (err, response) {
 ...
 * @returns {object}
 */
sophia.updateAccount = function (account_name, json_meta, owner, active, memo_key, private_key, callback) {
    return sophia.call('update_account', [account_name, json_meta, owner, active, memo_key], function (err, response) {
        if (err) callback(err, null);else {
            sophia.startBroadcasting(response, private_key, callback);
        }
    });
 ...
 * @returns {object}
 */
sophia.deleteAccount = function (account_name, private_key, callback) {
    return sophia.call('delete_account', [account_name], function (err, response) {
        if (err) callback(err, '');else {
            sophia.startBroadcasting(response, private_key, callback);
        }
    });
 ...
 * @returns {object}
 */
sophia.transfer = function (from, to, amount, memo, private_key, callback) {
 ...
 * @returns {object}
 */
sophia.transferToVesting = function (from, to, amount, private_key, callback) {
 ...
 * @returns {object}
 */
sophia.setVotingProxy = function (account_to_modify, proxy, private_key, callback) {
    return sophia.call('set_voting_proxy', [account_to_modify, proxy], function (err, response) {
        if (err) callback(err, '');else {
            sophia.startBroadcasting(response, private_key, callback);
        }
    });
 ...
 * @returns {object}
 */
sophia.voteForWitness = function (accountToVoteWith, witness_to_vote_for) {
    var approve = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
    var private_key = arguments[3];
    var callback = arguments[4];

    return sophia.call('vote_for_witness', [accountToVoteWith, witness_to_vote_for, approve], function (err, response) {
        if (err) callback(err, '');else {
            sophia.startBroadcasting(response, private_key, callback);
        }
    });
 ...
 * @returns {object}
 */
sophia.withdrawVesting = function (from, vesting_shares, private_key, callback) {
    return sophia.call('withdraw_vesting', [from, vesting_shares], function (err, response) {
        if (err) callback(err, '');else {
            sophia.startBroadcasting(response, private_key, callback);
        }
    });
 ...
 * @returns {object}
 */
sophia.updateWitness = function (account_name, url, block_signing_key, accountCreationFee, maximumBlockSizeLimit, prizeFeeds, private_key, callback) {
    ...
    return sophia.call('update_witness', [account_name, url, block_signing_key, props], function (err, response) {
        if (err) callback(err, '');else {
            sophia.startBroadcasting(response, private_key, callback);
        }
    });
