...
var Sophia = function (_EventEmitter) {
    ...
    _createClass(Sophia, [{
        ...
        value: function startBroadcasting(operation, privateKey, callback) {
            ...
            try {
                return this.call('create_simple_transaction', [operation], function (err, response) {
                    if (err) callback(err, '');else {
                        ...
                        _this2.call('broadcast_transaction', [signedTransaction], function (err, response) {
                            if (err) {
                                // logger.log(err);
                                callback(err, '');
                            } else {
        ...
        value: function startBroadcastingDaemonMethods(operation, privateKey, callback) {
            ...
            var createtransaction = void 0;
            try {
                return this.call('calculate_fee', [operation, 'SPHTX'], function (err, response) {
                    if (err) callback(err, '');else {
                        _this3.call('add_fee', [operation, response], function (err, response) {
                            if (err) callback(err, '');else {
                                transaction = response;
                                _this3.call('about', [operation, response], function (err, response) {
                                    if (err) callback(err, '');else {
                                        chainId = response.chain_id;
                                        _this3.call('create_simple_transaction', [transaction], function (err, response) {
                                            if (err) callback(err, '');else {
                                                createtransaction = response;
                                                // this.call('get_transaction_digest', [createtransaction], (err, response) => {
                                                //     if (err) {
                                                ...
                                                _this3.call('broadcast_transaction', [signedTransaction], function (err, response) {
                                                    if (err) {
                                                        // logger.log(err);
                                                        callback(err, '');
                                                    } else {
...
sophia.updateAccount = function (accountName, jsonMeta, owner, active, memoKey, privateKey, callback) {
    return sophia.call('update_account', [accountName, jsonMeta, owner, active, memoKey], function (err, response) {
...
sophia.deleteAccount = function (accountName, privateKey, callback) {
    return sophia.call('delete_account', [accountName], function (err, response) {
        if (err) callback(err, '');else {
            sophia.startBroadcasting(response, privateKey, callback);
        }
    });
...
sophia.transfer = function (from, to, amount, memo, privateKey, callback) {
    return sophia.call('transfer', [from, to, amount, memo], function (err, response) {
        if (err) callback(err, '');else {
            sophia.startBroadcasting(response, privateKey, callback);
        }
    });
...
sophia.about = function (callback) {
    return sophia.call('about', [], function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.info = function (callback) {
    return sophia.call('info', [], function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.help = function (callback) {
    return sophia.call('help', [], function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.getWitness = function (nameOfTheWitness, callback) {
    return sophia.call('get_witness', [nameOfTheWitness], function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.listWitnesses = function (name, limit, callback) {
    return sophia.call('list_witnesses', [name, limit], function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.listWitnessesByVote = function (name, limit, callback) {
    return sophia.call('list_witnesses_by_vote', [name, limit], function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.getBlock = function (blockNum, callback) {
    return sophia.call('get_block', [blockNum], function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.getOpsInBlock = function (blockNum, onlyVirtual, callback) {
    return sophia.call('get_ops_in_block', [blockNum, onlyVirtual], function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.getFeedHistory = function (symbol, callback) {
    return sophia.call('get_feed_history', [symbol], function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.getAccount = function (name, callback) {
    return sophia.call('get_account', [name], function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.getTransaction = function (trxId, callback) {
    return sophia.call('get_transaction', [trxId], function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.getAccountNameFromSeed = function (seed, callback) {
    return sophia.call('get_account_name_from_seed', [seed], function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.accountExist = function (accountName, callback) {
    return sophia.call('account_exist', [accountName], function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.getActiveAuthority = function (accountName, callback) {
    return sophia.call('get_active_authority', [accountName], function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.getOwnerAuthority = function (accountName, callback) {
    return sophia.call('get_owner_authority', [accountName], function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.getMemoKey = function (accountName, callback) {
    return sophia.call('get_memo_key', [accountName], function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.getAccountBalance = function (accountName, callback) {
    return sophia.call('get_account_balance', [accountName], function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.getVestingBalance = function (accountName, callback) {
    return sophia.call('get_vesting_balance', [accountName], function (err, response) {
        if (err) callback(err, '');else {
            callback('', response);
        }
    });
...
sophia.sponsorAccountFees = function (sponsoring_account, sponsored_account, is_sponsoring, privateKey, callback) {
    return sophia.call('sponsor_account_fees', [sponsoring_account, sponsored_account, is_sponsoring], function (err, response) {
        if (err) callback(err, '');else {
            //callback('', response);
            sophia.startBroadcasting(response, privateKey, callback);
        }
...
sophia.getReceivedDocuments = function (appId, accountName, searchType, start, count, callback) {
    return sophia.call('get_received_documents', [appId, accountName, searchType, start, count], function (err, response) {
        if (err) callback(err, '');else {
            if (response.length > 0) {
                response.forEach(function (r) {
...
sophia.makeCustomJSONOperation = function (appId, from, to, data, privateKey, callback) {
    return sophia.call('make_custom_json_operation', [appId, from, to, data], function (err, response) {
        if (err) callback(err, '');else {
            sophia.startBroadcasting(response, privateKey, callback);
        }
    });
...
sophia.makeCustomBinaryOperation = function (appId, from, to, data, privateKey, callback) {
    return sophia.call('make_custom_binary_operation', [appId, from, to, data], function (err, response) {
        if (err) callback(err, '');else {
            sophia.startBroadcasting(response, privateKey, callback);
        }
    });
