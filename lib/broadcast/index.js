...
steemBroadcast.send = function steemBroadcast$send(tx) {
  var privKeys = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '5JPwY3bwFgfsGtxMeLkLqXzUrQDMAsqSyAZDnMBkg7PDDRhQgaV';
...
steemBroadcast._prepareTransaction = function steemBroadcast$_prepareTransaction(tx) {
  ...
  return propertiesP.then(function (properties) {
    ...
    return _api2.default.getBlockAsync(properties.last_irreversible_block_num).then(function (block) {
